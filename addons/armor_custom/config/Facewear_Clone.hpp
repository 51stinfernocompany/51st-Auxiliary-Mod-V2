class ic51_vest_sergeantmajor;
class ic51_vest_atticus: ic51_vest_sergeantmajor
{
    SCOPE_PUBLIC;
    ...
    /*3*/	"",
    /*4*/	QPATHTOF(data\facewear_clone\facewear_kama_atticus_co.paa),
    /*5*/	"",
    /*6*/	"",
...
class ic51_vest_arc_jinx: ic51_vest_arc
{
    ...
    /*3*/	QPATHTOF(data\facewear_clone\facewear_kama_arc_jinx_co.paa),
    /*4*/	"",
    /*5*/	"",
    /*6*/	"",
    /*7*/	"",
