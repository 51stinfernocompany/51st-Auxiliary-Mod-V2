...
if (_logic getVariable ["ic51_ddbx_done", false]) exitWith {};
_logic setVariable ["ic51_ddbx_done", true, true];

// === TUNABLES (edit these) ===
private _dropAltitude    = 1000;                     // meters above module pos
private _dispenserClass  = "ic51_droidDespener_bx";  // falling object classname
...
private _handle = _args spawn ic51_fnc_spawnCrateWave_bx;
