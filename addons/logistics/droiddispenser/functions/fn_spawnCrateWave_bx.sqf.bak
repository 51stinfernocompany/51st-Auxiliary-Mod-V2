...
// Classes
private _dropClass  = "ic51_droidDespener_DropProxy_bx"; // falls
private _finalClass = "ic51_droidDespener_bx";           // tanky, destroyable
...
if (_unitClasses isEqualTo []) then {
    private _defaults = switch (_side) do {
        ...
        default {["ic51_opfor_unit_bx_standard"]};
    };
